...
const Beasiswa = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const url = await fetch('../../api/handleBeasiswa', { cache: "no-store" })
    ...
    return (
        <div className={styles.body}>
            ...
            <section className={styles.page}>
                <h2 className="font-bold text-[1.5rem] justify-center">Daftar Beasiswa</h2>
                ...
                <div className={styles.card}>
                    ...
                    <ul className="grid md:grid-cols-3 grid-cols-1 md:gap-4 gap-2 ">
                        {data.map((datas) => {
                            return (
                                <li key={datas.id_Beasiswa} className="bg-white rounded-md shadow-none scale-100 transition-all hover:shadow-2xl hover:scale-105 p-4">
                                    <Image src={datas.image_Besiswa} width={300} height={300} alt="sfsf"></Image>
